...
if(use1pt){
var x=await fetch(`https://tinyurl.com/api-create.php?url=${encodeURIComponent(cUrl)}`).then(res => res.json());
var y=await fetch(`https://tinyurl.com/api-create.php?url=${encodeURIComponent(wUrl)}`).then(res => res.json());
